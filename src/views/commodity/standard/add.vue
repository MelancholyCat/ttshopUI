  ...
  <div class="app-container">
    <el-form ref="form" :model="standard" label-width="120px">
      <el-form-item label="所属商品">
        <el-input v-model="standard.commodityName" :disabled="true" value="standard.commodityName"/>
      </el-form-item>
      <el-form-item label="规格详情">
        <el-input v-model="standard.detail" placeholder="请输入内容"/>
      </el-form-item>
      <el-form-item label="单价">
        <el-input v-model="standard.unitPrice" placeholder="请输入内容"/>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // },
    fatchData() {
      this.standard.commodityId = this.$route.params.id;
      var vm = this;
      this.axios({
        method: "GET",
        url: "http://203.195.219.146:8080/commodity/" + vm.standard.commodityId
        // url: "https://www.fastmock.site/mock/06c8be06c16b30764c466badda582793/ttshop/commodity/"+vm.standard.commodity_id
      }).then(function(resp) {
        vm.standard.commodityName = resp.data.data.name;
    ...
    onSubmit() {
      ...
      this.axios({
        method: "POST",
        url: "http://203.195.219.146:8080/standard/add",
        ...
        if (resp.data.code == 200) {
          ...
          // type: 'success'
          // });
          vm.$router.push("/standard/index/"+vm.standard.commodityId);
        } else {
    ...
    onCancel() {
      this.$router.push("/standard/index/"+this.standard.commodityId);
    }
  }
};
</script>
